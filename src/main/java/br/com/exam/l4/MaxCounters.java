...
public class MaxCounters {
	...
	public static void main(String[] args) {
		System.out.println(Arrays.toString(solution(10, new int[] { 1, 2, 11, 10, 9, 6, 11, 5 })));
		...
		System.out.println(Arrays.toString(solution(1, new int[] { 2 })));
	}

	public static int[] solution(int N, int[] A) {
		int[] counters = new int[N];
		int max = 0;
		boolean maxBefore = false;
